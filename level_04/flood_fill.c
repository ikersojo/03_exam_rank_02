...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/01 13:33:51 by isojo-go          #+#    #+#             */
...
/*	Assignment name  : flood_fill
	...
	entire zone by replacing characters inside with the character 'F'. A zone
	is an group of the same character delimitated horizontally and vertically
